...
abstract class IAnalyticsRepository {
  ...
  Future<Either<Failure, Success>> analyticsAttemptScannedItems(
      Map<String, dynamic> scanResult, InventoryItemModel expectedItem);
  ...
  Future<Either<Failure, Success>> analyticsRedirectToShopEventItemId(
      String url, String userId, String itemId);
...
const String analytics_redirectToShopEventId =
    "analytics_redirectToShopEventId";
...
class AnalyticsRepository extends IAnalyticsRepository {
  ...
  AnalyticsRepository(this._sharedPref,
      {this.googleAnalyticsRemoteDS, this.rudderStackRemoteDS});
